                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?php echo SiteInfo::get_css_url() ?>/themes/admin/img/avatar2.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="pull-left">
                                                    <img src="<?php echo SiteInfo::get_css_url() ?>/themes/admin/img/avatar.png" class="img-circle" alt="user image"/>
                                                </div>
                                                <h4>
                                                    Developers
...
?>
                        ...
                        <!--
                        <li class="active">
                            <a href="<?php echo PC_Config::url() ?>/admin/ad/">
                                <i class="fa fa-edit"></i> <span>ad管理</span>
                           </a>
                        </li>
                    -->
                        <li class="active">
